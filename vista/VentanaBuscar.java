...
public class VentanaBuscar  extends JFrame implements ActionListener {
	...
	private PersonaController miCoordinador; //objeto miCoordinador que permite la relacion entre esta clase y la clase coordinador
	...
	public VentanaBuscar() {
		...
		setSize(480, 320);
		setTitle("ADOO : Patrones de Diseño/MVC");
		setLocationRelativeTo(null);
		setResizable(false);
		setLayout(null);
	}

	public void setCoordinador(PersonaController miCoordinador) {
	...
	public void actionPerformed(ActionEvent e) 
	{
		if (e.getSource()==botonGuardar)
		{
			try {
				...
				if (Persona.modificaPersona==true) {
		...
		if (e.getSource()==botonBuscar)
		{
			...
			else if(Persona.consultaPersona==true){
